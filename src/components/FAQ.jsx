...
const FAQ = () => {
  ...
  return (
    <>
      <div className="mt-20 text-3xl font-semibold tracking-wide leading-8 text-violet-700 max-md:mt-10">
      ...
      <div className="flex flex-col mt-7 max-w-full bg-purple-50 rounded-lg w-[846px] max-md:px-5">
        <div className='flex items-center justify-between p-6'>
          ...
          <button onClick={() => toggleAccordion(0)}>
            {expanded[0] ? <MinusIcon className="h-6 w-6 text-purple-700 cursor-pointer" /> : <PlusIcon className="h-6 w-6 text-purple-700 cursor-pointer" />}
          </button>
        </div>
        {expanded[0] && (
      ...
      <div className="flex flex-col mt-4 max-w-full bg-purple-50 rounded-lg w-[846px] max-md:px-5">
        <div className='flex items-center justify-between p-6'>
          ...
          <button onClick={() => toggleAccordion(1)}>
            {expanded[1] ? <MinusIcon className="h-6 w-6 text-purple-700 cursor-pointer" /> : <PlusIcon className="h-6 w-6 text-purple-700 cursor-pointer" />}
          </button>
        </div>
        {expanded[1] && (
          <div className="text-lg leading-8 text-slate-500 max-md:max-w-full p-6">
      ...
      <div className="flex flex-col mt-4 max-w-full bg-purple-50 rounded-lg w-[846px] max-md:px-5">
        <div className='flex items-center justify-between p-6'>
          ...
          <button onClick={() => toggleAccordion(2)}>
            {expanded[2] ? <MinusIcon className="h-6 w-6 text-purple-700 cursor-pointer" /> : <PlusIcon className="h-6 w-6 text-purple-700 cursor-pointer" />}
          </button>
        </div>
        {expanded[2] && (
          <div className="text-lg leading-8 text-slate-500 max-md:max-w-full p-6">
